...
@section('content')
    ...
    <div align="center">
        <form method="POST" action="{{ url('processBillUpload') }}"  enctype="multipart/form-data"  accept-charset="utf-8"  name="applicationForm"  v-form>
                ...
                <div class="md-card">
                    <div class="md-card-content">
                        <h3 class="heading_a uk-margin-small-bottom">
                            Upload Bills file here  Max size - Excel format only (2MB) - remove columns headers before uploading
                        </h3>
